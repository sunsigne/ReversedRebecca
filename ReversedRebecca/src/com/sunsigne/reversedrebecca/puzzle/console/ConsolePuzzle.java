...
public abstract class ConsolePuzzle extends Puzzle {

	public ConsolePuzzle(ToolPlayer toolPlayer, GenericListenerBoolean actionOnWinning, GenericListener actionOnLosing) {
	...
	public PuzzleFactory getFactory() {
		return new ConsolePuzzleFactory();
	}
	...
	protected void setStaticNoCritCount(int noCritCount) {
		ConsolePuzzle.noCritCount = noCritCount;
	}
