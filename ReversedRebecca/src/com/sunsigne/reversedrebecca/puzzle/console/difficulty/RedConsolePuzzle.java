...
public class RedConsolePuzzle extends KeyPuzzle {

	public RedConsolePuzzle(ToolPlayer toolPlayer, GenericListenerBoolean actionOnWinning, GenericListener actionOnLosing) {
