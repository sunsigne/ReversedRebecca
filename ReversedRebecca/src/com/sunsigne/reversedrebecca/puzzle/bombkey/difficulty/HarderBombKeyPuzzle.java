...
public class HarderBombKeyPuzzle extends BombKeyPuzzle {

	public HarderBombKeyPuzzle(ToolPlayer toolPlayer, GenericListener actionOnWinning, GenericListener actionOnLosing) {
