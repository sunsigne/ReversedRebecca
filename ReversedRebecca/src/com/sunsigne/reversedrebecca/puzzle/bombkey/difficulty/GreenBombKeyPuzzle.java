...
public class GreenBombKeyPuzzle extends BombKeyPuzzle {

	public GreenBombKeyPuzzle(ToolPlayer toolPlayer, GenericListener actionOnWinning, GenericListener actionOnLosing) {
	...
	public int getBombLockAmount() {
		if(amount == 0)
			amount = new RandomGenerator().getIntBetween(5, 6);
		return amount;
	}
