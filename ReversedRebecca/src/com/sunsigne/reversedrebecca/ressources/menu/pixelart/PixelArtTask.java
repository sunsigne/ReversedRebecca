...
public class PixelArtTask implements UnlockableTask {
	...
	public void create(String name) {
		...
		boolean hasText = Boolean.parseBoolean(new FileTask().read(false, path + "text.txt"));
		...
		PixelArt pixelArt = new PixelArt(name, location, facing, hasText, image, image_locked);
