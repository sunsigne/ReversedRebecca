...
public class LostPuzzleCondition extends GlobalInstruction {

	////////// GLOBAL INSTRUCTION ////////////

	public LostPuzzleCondition() {
		GlobalInstructionList.getList().addObject(this);
	}
	
	private static GlobalInstruction globalInstruction = new LostPuzzleCondition();
