...
public class EnteringCondition extends GlobalInstruction {

	////////// GLOBAL INSTRUCTION ////////////

	public EnteringCondition() {
		GlobalInstructionList.getList().addObject(this);
	}
	
	private static GlobalInstruction globalInstruction = new EnteringCondition();
