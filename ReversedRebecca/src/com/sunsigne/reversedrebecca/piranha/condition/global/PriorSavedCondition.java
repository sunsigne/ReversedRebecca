...
public class PriorSavedCondition extends GlobalInstruction {
	
	////////// GLOBAL INSTRUCTION ////////////

	public PriorSavedCondition() {
		GlobalInstructionList.getList().addObject(this);
	}
	
	private static GlobalInstruction globalInstruction = new PriorSavedCondition();
