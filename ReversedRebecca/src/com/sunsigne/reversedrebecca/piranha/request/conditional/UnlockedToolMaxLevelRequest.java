...
public class UnlockedToolMaxLevelRequest extends ConditionalRequest {

	////////// REQUEST ////////////

	public UnlockedToolMaxLevelRequest() {
		new RequestList().addRequest(this, getType());
	}

	private static Request request = new UnlockedToolMaxLevelRequest();
	...
	protected boolean analyseCondition(PiranhaObject object, String target) {
		...
		return new DifficultyComparator().canUseTool(lvl, tool.getMaxDifficulty());
	}
