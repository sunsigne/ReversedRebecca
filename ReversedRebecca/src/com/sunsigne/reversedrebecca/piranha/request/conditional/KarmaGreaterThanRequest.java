...
public class KarmaGreaterThanRequest extends ConditionalRequest {

	////////// REQUEST ////////////

	public KarmaGreaterThanRequest() {
		new RequestList().addRequest(this, getType());
	}

	private static Request request = new KarmaGreaterThanRequest();
