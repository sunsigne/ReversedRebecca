...
import com.sunsigne.reversedrebecca.piranha.request.state.TextureNameRequest;

public class TextureNamePlayerRequest extends TextureNameRequest {

	////////// REQUEST ////////////

	public TextureNamePlayerRequest() {
		new RequestList().addRequest(this, getType());
	}

	private static Request request = new TextureNamePlayerRequest();
