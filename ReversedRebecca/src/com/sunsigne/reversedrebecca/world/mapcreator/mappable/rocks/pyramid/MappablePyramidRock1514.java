...
public class MappablePyramidRock1514 implements Mappable {

	private MappablePyramidRock1514() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1514();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
