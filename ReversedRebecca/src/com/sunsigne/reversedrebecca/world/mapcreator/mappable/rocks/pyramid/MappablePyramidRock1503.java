...
public class MappablePyramidRock1503 implements Mappable {

	private MappablePyramidRock1503() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1503();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
