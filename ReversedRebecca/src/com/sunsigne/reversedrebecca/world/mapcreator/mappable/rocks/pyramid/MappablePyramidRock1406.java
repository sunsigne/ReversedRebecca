...
public class MappablePyramidRock1406 implements Mappable {

	private MappablePyramidRock1406() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1406();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
