...
public class MappablePyramidRock0900 implements Mappable {

	private MappablePyramidRock0900() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0900();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 0, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
