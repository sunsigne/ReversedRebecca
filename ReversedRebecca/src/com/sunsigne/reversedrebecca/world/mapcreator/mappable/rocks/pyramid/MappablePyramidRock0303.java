...
public class MappablePyramidRock0303 implements Mappable {

	private MappablePyramidRock0303() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0303();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
