...
public class MappablePyramidRock1315 implements Mappable {

	private MappablePyramidRock1315() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1315();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
