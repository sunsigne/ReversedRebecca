...
public class MappablePyramidRock0915 implements Mappable {

	private MappablePyramidRock0915() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0915();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 15, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
