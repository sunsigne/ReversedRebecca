...
public class MappablePyramidRock1407 implements Mappable {

	private MappablePyramidRock1407() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1407();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 7, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
