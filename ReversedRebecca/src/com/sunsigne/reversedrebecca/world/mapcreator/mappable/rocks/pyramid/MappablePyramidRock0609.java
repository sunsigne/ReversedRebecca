...
public class MappablePyramidRock0609 implements Mappable {

	private MappablePyramidRock0609() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0609();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
