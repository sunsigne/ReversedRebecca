...
public class MappablePyramidRock0512 implements Mappable {

	private MappablePyramidRock0512() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0512();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
