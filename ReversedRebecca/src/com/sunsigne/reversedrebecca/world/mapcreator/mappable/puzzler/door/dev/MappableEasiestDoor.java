...
public class MappableEasiestDoor implements Mappable {

	private MappableEasiestDoor() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappableEasiestDoor();
	...
	public GameObject createObject(int x, int y) {
		return new DevDoorObject(DEV_LVL.EASIEST, x, y);
	}
