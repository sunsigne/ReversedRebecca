...
public class MappablePyramidRock0001 implements Mappable {

	private MappablePyramidRock0001() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0001();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 1, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);
		return rock;
	}
