...
public class MappablePyramidRock0604 implements Mappable {

	private MappablePyramidRock0604() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0604();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
