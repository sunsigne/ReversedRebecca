...
public class MappablePyramidRock0913 implements Mappable {

	private MappablePyramidRock0913() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0913();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
