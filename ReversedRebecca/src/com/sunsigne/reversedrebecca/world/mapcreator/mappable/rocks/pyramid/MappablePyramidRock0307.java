...
public class MappablePyramidRock0307 implements Mappable {

	private MappablePyramidRock0307() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0307();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 7, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
