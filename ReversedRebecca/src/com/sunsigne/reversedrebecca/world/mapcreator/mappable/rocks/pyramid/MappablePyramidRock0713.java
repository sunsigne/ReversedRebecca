...
public class MappablePyramidRock0713 implements Mappable {

	private MappablePyramidRock0713() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0713();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 13, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
