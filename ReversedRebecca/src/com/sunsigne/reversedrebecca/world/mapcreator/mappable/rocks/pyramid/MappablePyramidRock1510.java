...
public class MappablePyramidRock1510 implements Mappable {

	private MappablePyramidRock1510() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1510();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
