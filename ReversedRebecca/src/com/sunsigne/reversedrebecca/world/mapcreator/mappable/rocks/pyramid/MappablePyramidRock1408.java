...
public class MappablePyramidRock1408 implements Mappable {

	private MappablePyramidRock1408() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1408();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
