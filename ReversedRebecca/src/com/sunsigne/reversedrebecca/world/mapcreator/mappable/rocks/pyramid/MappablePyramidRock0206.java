...
public class MappablePyramidRock0206 implements Mappable {

	private MappablePyramidRock0206() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0206();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
