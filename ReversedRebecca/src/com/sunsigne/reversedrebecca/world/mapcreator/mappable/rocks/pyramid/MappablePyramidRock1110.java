...
public class MappablePyramidRock1110 implements Mappable {

	private MappablePyramidRock1110() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1110();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 10, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
