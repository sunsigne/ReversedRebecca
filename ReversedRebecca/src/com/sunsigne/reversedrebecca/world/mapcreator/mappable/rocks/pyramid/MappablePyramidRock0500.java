...
public class MappablePyramidRock0500 implements Mappable {

	private MappablePyramidRock0500() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0500();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
