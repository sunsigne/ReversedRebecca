...
public class MappablePyramidRock1207 implements Mappable {

	private MappablePyramidRock1207() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1207();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 7, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
