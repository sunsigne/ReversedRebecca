...
public class MappablePyramidRock1013 implements Mappable {

	private MappablePyramidRock1013() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1013();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 13, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
