...
public class MappablePyramidRock0603 implements Mappable {

	private MappablePyramidRock0603() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0603();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
