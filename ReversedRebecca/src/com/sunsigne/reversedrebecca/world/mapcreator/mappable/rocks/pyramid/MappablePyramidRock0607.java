...
public class MappablePyramidRock0607 implements Mappable {

	private MappablePyramidRock0607() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0607();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 7, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
