...
public class MappablePyramidRock0302 implements Mappable {

	private MappablePyramidRock0302() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0302();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 2, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
