...
public class MappablePyramidRock0712 implements Mappable {

	private MappablePyramidRock0712() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0712();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
