...
public class MappablePyramidRock0401 implements Mappable {

	private MappablePyramidRock0401() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0401();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
