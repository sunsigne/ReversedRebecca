...
public class MappablePyramidRock0414 implements Mappable {

	private MappablePyramidRock0414() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0414();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 14, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);
		return rock;
	}
