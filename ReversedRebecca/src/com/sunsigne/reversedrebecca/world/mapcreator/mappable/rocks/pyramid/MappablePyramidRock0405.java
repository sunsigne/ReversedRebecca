...
public class MappablePyramidRock0405 implements Mappable {

	private MappablePyramidRock0405() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0405();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 5, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
