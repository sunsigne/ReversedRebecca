...
public class MappablePyramidRock1409 implements Mappable {

	private MappablePyramidRock1409() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1409();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
