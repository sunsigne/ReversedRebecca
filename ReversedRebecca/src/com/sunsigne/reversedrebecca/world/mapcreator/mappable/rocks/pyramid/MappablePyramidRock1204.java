...
public class MappablePyramidRock1204 implements Mappable {

	private MappablePyramidRock1204() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1204();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
