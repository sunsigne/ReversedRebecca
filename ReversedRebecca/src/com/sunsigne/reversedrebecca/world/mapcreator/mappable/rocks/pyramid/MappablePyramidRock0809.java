...
public class MappablePyramidRock0809 implements Mappable {

	private MappablePyramidRock0809() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0809();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
