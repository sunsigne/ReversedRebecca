...
public class MappablePyramidRock1307 implements Mappable {

	private MappablePyramidRock1307() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1307();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 7, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
