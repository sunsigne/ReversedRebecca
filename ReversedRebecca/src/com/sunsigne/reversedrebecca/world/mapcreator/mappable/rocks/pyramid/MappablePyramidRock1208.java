...
public class MappablePyramidRock1208 implements Mappable {

	private MappablePyramidRock1208() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1208();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
