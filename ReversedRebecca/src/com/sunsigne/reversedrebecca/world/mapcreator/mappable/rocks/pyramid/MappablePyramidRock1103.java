...
public class MappablePyramidRock1103 implements Mappable {

	private MappablePyramidRock1103() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1103();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
