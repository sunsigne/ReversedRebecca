...
public class MappablePyramidRock1311 implements Mappable {

	private MappablePyramidRock1311() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1311();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
