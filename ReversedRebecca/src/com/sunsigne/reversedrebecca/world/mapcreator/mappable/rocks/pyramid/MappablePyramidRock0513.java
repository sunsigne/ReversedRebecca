...
public class MappablePyramidRock0513 implements Mappable {

	private MappablePyramidRock0513() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0513();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
