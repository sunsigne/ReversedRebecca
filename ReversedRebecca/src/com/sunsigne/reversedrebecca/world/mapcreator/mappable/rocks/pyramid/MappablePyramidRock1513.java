...
public class MappablePyramidRock1513 implements Mappable {

	private MappablePyramidRock1513() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1513();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
