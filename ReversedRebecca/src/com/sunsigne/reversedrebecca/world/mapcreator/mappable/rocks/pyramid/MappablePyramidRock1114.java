...
public class MappablePyramidRock1114 implements Mappable {

	private MappablePyramidRock1114() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1114();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
