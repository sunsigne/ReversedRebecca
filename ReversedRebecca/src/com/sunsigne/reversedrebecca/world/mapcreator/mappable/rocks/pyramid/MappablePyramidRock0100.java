...
public class MappablePyramidRock0100 implements Mappable {

	private MappablePyramidRock0100() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0100();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
