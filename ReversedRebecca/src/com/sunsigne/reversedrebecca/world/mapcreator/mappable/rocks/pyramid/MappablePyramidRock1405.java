...
public class MappablePyramidRock1405 implements Mappable {

	private MappablePyramidRock1405() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1405();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 5, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
