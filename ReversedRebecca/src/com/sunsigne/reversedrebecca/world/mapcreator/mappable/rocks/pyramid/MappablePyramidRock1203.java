...
public class MappablePyramidRock1203 implements Mappable {

	private MappablePyramidRock1203() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1203();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
