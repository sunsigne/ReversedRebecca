...
public class MappablePyramidRock0715 implements Mappable {

	private MappablePyramidRock0715() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0715();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
