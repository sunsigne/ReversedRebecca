...
public class MappablePyramidRock0202 implements Mappable {

	private MappablePyramidRock0202() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0202();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
