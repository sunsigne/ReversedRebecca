...
public class MappablePyramidRock0002 implements Mappable {

	private MappablePyramidRock0002() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0002();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);
		return rock;
	}
