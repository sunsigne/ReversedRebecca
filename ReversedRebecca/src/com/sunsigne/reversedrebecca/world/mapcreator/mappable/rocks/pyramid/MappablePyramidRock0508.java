...
public class MappablePyramidRock0508 implements Mappable {

	private MappablePyramidRock0508() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0508();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 8, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
