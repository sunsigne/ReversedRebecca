...
public class MappablePyramidRock0501 implements Mappable {

	private MappablePyramidRock0501() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0501();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
