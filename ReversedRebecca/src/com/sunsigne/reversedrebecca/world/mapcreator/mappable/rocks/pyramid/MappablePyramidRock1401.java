...
public class MappablePyramidRock1401 implements Mappable {

	private MappablePyramidRock1401() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1401();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
