...
public class MappablePyramidRock1301 implements Mappable {

	private MappablePyramidRock1301() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1301();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 1, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
