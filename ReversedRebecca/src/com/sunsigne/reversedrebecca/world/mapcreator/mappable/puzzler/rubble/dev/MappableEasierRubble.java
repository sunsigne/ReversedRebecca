...
public class MappableEasierRubble implements Mappable {

	private MappableEasierRubble() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappableEasierRubble();
	...
	public GameObject createObject(int x, int y) {
		return new DevRubbleObject(DEV_LVL.EASIER, x, y);
	}
