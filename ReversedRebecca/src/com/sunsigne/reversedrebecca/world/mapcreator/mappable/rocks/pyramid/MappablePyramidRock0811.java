...
public class MappablePyramidRock0811 implements Mappable {

	private MappablePyramidRock0811() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0811();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
