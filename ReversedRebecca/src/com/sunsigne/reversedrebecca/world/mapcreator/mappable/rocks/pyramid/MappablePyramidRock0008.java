...
public class MappablePyramidRock0008 implements Mappable {

	private MappablePyramidRock0008() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0008();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
