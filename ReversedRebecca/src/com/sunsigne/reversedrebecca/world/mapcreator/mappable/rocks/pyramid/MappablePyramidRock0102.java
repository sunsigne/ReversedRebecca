...
public class MappablePyramidRock0102 implements Mappable {

	private MappablePyramidRock0102() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0102();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 2, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
