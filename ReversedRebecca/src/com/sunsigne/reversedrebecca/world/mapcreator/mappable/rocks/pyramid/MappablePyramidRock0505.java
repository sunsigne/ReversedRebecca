...
public class MappablePyramidRock0505 implements Mappable {

	private MappablePyramidRock0505() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0505();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 5, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
