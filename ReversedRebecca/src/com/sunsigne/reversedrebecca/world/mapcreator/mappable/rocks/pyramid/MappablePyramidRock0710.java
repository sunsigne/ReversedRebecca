...
public class MappablePyramidRock0710 implements Mappable {

	private MappablePyramidRock0710() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0710();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 10, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
