...
public class MappablePyramidRock0810 implements Mappable {

	private MappablePyramidRock0810() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0810();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
