...
public class MappablePyramidRock0114 implements Mappable {

	private MappablePyramidRock0114() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0114();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
