...
public class MappablePyramidRock1100 implements Mappable {

	private MappablePyramidRock1100() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1100();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
