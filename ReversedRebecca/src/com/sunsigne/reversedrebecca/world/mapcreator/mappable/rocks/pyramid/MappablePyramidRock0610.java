...
public class MappablePyramidRock0610 implements Mappable {

	private MappablePyramidRock0610() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0610();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 10, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
