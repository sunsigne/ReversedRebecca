...
public class MappablePyramidRock1305 implements Mappable {

	private MappablePyramidRock1305() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1305();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 5, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
