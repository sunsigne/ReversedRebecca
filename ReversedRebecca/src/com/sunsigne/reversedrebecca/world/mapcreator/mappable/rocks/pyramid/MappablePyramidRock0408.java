...
public class MappablePyramidRock0408 implements Mappable {

	private MappablePyramidRock0408() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0408();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 8, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
