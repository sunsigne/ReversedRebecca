...
public class MappablePyramidRock0304 implements Mappable {

	private MappablePyramidRock0304() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0304();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
