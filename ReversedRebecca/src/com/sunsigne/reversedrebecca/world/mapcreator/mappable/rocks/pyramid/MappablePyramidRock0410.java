...
public class MappablePyramidRock0410 implements Mappable {

	private MappablePyramidRock0410() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0410();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
