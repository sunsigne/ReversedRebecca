...
public class MappablePyramidRock1005 implements Mappable {

	private MappablePyramidRock1005() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1005();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 5, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
