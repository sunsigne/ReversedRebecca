...
public class MappablePyramidRock1004 implements Mappable {

	private MappablePyramidRock1004() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1004();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 4, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
