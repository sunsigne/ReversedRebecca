...
public class MappablePyramidRock0005 implements Mappable {

	private MappablePyramidRock0005() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0005();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 5, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
