...
public class MappablePyramidRock0506 implements Mappable {

	private MappablePyramidRock0506() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0506();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
