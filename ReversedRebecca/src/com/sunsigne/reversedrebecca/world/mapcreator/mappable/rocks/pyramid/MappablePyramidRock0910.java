...
public class MappablePyramidRock0910 implements Mappable {

	private MappablePyramidRock0910() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0910();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 10, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
