...
public class MappablePyramidRock0704 implements Mappable {

	private MappablePyramidRock0704() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0704();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 4, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
