...
public class MappablePyramidRock0108 implements Mappable {

	private MappablePyramidRock0108() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0108();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
