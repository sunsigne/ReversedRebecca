...
public class MappablePyramidRock1515 implements Mappable {

	private MappablePyramidRock1515() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1515();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
