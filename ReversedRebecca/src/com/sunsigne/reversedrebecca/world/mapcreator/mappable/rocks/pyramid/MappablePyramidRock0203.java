...
public class MappablePyramidRock0203 implements Mappable {

	private MappablePyramidRock0203() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0203();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
