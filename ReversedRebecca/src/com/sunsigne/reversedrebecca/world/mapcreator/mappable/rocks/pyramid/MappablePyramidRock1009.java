...
public class MappablePyramidRock1009 implements Mappable {

	private MappablePyramidRock1009() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1009();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
