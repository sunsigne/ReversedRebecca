...
public class MappablePyramidRock1200 implements Mappable {

	private MappablePyramidRock1200() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1200();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
