...
public class MappablePyramidRock0814 implements Mappable {

	private MappablePyramidRock0814() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0814();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 14, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
