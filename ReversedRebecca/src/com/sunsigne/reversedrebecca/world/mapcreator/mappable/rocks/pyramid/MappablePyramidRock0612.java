...
public class MappablePyramidRock0612 implements Mappable {

	private MappablePyramidRock0612() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0612();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 12, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
