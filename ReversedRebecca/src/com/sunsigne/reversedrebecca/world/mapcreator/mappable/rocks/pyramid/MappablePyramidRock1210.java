...
public class MappablePyramidRock1210 implements Mappable {

	private MappablePyramidRock1210() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1210();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
