...
public class MappablePyramidRock1500 implements Mappable {

	private MappablePyramidRock1500() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1500();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
