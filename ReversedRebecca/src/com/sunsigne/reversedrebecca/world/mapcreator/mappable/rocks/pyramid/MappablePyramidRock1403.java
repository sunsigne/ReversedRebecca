...
public class MappablePyramidRock1403 implements Mappable {

	private MappablePyramidRock1403() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1403();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 3, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
