...
public class MappablePyramidRock1404 implements Mappable {

	private MappablePyramidRock1404() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1404();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 4, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
