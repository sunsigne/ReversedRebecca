...
public class MappablePyramidRock1511 implements Mappable {

	private MappablePyramidRock1511() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1511();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
