...
public class MappablePyramidRock0212 implements Mappable {

	private MappablePyramidRock0212() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0212();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 12, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
