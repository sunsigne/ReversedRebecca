...
public class MappablePyramidRock0105 implements Mappable {

	private MappablePyramidRock0105() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0105();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 5, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
