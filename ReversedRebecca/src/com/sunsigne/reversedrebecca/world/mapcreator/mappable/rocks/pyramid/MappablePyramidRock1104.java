...
public class MappablePyramidRock1104 implements Mappable {

	private MappablePyramidRock1104() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1104();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
