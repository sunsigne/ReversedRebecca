...
public class MappablePyramidRock0709 implements Mappable {

	private MappablePyramidRock0709() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0709();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
