...
public class MappablePyramidRock0700 implements Mappable {

	private MappablePyramidRock0700() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0700();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 0, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
