...
public class MappablePyramidRock0014 implements Mappable {

	private MappablePyramidRock0014() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0014();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
