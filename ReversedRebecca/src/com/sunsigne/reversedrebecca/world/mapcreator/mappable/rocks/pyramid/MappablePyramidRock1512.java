...
public class MappablePyramidRock1512 implements Mappable {

	private MappablePyramidRock1512() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1512();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
