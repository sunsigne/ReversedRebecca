...
public class MappablePyramidRock0905 implements Mappable {

	private MappablePyramidRock0905() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0905();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 5, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
