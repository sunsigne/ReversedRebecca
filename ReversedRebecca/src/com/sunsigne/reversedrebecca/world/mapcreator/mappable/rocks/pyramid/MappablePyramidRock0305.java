...
public class MappablePyramidRock0305 implements Mappable {

	private MappablePyramidRock0305() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0305();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 5, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
