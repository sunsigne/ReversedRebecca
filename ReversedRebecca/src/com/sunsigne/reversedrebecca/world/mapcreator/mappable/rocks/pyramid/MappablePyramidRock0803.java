...
public class MappablePyramidRock0803 implements Mappable {

	private MappablePyramidRock0803() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0803();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
