...
public class MappablePyramidRock0903 implements Mappable {

	private MappablePyramidRock0903() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0903();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
