...
public class MappablePyramidRock0708 implements Mappable {

	private MappablePyramidRock0708() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0708();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 8, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
