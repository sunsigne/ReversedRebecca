...
public class MappablePyramidRock1413 implements Mappable {

	private MappablePyramidRock1413() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1413();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 13, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
