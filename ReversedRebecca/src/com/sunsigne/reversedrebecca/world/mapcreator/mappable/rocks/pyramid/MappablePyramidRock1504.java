...
public class MappablePyramidRock1504 implements Mappable {

	private MappablePyramidRock1504() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1504();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
