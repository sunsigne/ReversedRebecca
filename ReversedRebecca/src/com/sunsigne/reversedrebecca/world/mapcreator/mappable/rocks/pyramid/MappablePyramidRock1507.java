...
public class MappablePyramidRock1507 implements Mappable {

	private MappablePyramidRock1507() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1507();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 7, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
