...
public class MappablePyramidRock1314 implements Mappable {

	private MappablePyramidRock1314() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1314();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 14, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
