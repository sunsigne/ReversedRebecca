...
public class MappablePyramidRock0805 implements Mappable {

	private MappablePyramidRock0805() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0805();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 5, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
