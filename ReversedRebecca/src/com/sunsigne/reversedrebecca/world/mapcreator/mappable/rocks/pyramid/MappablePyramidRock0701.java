...
public class MappablePyramidRock0701 implements Mappable {

	private MappablePyramidRock0701() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0701();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
