...
public class MappablePyramidRock0502 implements Mappable {

	private MappablePyramidRock0502() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0502();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
