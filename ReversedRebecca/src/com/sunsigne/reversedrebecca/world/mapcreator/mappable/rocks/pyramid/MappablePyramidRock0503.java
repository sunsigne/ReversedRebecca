...
public class MappablePyramidRock0503 implements Mappable {

	private MappablePyramidRock0503() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0503();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
