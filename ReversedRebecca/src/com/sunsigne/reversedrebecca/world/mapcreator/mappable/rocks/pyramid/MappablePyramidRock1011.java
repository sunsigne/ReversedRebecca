...
public class MappablePyramidRock1011 implements Mappable {

	private MappablePyramidRock1011() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1011();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
