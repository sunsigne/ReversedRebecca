...
public class MappablePyramidRock0300 implements Mappable {

	private MappablePyramidRock0300() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0300();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 0, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
