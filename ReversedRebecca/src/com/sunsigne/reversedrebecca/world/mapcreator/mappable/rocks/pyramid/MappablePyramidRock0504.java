...
public class MappablePyramidRock0504 implements Mappable {

	private MappablePyramidRock0504() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0504();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 4, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
