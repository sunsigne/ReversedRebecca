...
public class MappablePyramidRock1113 implements Mappable {

	private MappablePyramidRock1113() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1113();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
