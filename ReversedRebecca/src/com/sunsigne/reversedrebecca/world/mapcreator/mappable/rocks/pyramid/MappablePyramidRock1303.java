...
public class MappablePyramidRock1303 implements Mappable {

	private MappablePyramidRock1303() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1303();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 3, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
