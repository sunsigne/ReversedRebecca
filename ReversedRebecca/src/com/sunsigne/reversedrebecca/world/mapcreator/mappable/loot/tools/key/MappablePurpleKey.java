...
public class MappablePurpleKey implements Mappable {

	private MappablePurpleKey() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePurpleKey();
	...
	public GameObject createObject(int x, int y) {
		return new ToolObject(new KeyToolPlayer(), LVL.PURPLE, x, y);
	}
