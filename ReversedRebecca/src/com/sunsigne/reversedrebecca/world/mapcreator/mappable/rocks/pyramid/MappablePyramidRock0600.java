...
public class MappablePyramidRock0600 implements Mappable {

	private MappablePyramidRock0600() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0600();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
