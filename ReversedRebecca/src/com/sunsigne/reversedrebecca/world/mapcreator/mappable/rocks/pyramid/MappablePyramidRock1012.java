...
public class MappablePyramidRock1012 implements Mappable {

	private MappablePyramidRock1012() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1012();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
