...
public class MappablePyramidRock0907 implements Mappable {

	private MappablePyramidRock0907() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0907();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 7, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
