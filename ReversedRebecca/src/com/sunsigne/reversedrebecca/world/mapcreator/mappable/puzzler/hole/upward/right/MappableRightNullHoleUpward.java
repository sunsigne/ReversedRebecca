...
public class MappableRightNullHoleUpward implements Mappable {

	private MappableRightNullHoleUpward() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappableRightNullHoleUpward();
