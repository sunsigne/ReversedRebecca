...
public class MappablePyramidRock0909 implements Mappable {

	private MappablePyramidRock0909() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0909();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
