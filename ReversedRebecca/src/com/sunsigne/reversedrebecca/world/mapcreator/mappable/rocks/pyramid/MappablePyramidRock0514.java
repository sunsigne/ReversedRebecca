...
public class MappablePyramidRock0514 implements Mappable {

	private MappablePyramidRock0514() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0514();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
