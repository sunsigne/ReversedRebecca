...
public class MappablePyramidRock1001 implements Mappable {

	private MappablePyramidRock1001() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1001();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
