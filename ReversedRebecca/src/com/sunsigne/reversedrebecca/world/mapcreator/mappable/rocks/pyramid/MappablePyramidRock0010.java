...
public class MappablePyramidRock0010 implements Mappable {

	private MappablePyramidRock0010() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0010();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
