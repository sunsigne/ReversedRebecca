...
public class MappablePyramidRock0614 implements Mappable {

	private MappablePyramidRock0614() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0614();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
