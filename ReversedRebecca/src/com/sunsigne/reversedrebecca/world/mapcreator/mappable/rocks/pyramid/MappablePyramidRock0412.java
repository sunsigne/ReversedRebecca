...
public class MappablePyramidRock0412 implements Mappable {

	private MappablePyramidRock0412() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0412();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
