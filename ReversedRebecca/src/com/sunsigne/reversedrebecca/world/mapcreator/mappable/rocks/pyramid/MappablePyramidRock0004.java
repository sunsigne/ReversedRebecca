...
public class MappablePyramidRock0004 implements Mappable {

	private MappablePyramidRock0004() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0004();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);
		return rock;
	}
