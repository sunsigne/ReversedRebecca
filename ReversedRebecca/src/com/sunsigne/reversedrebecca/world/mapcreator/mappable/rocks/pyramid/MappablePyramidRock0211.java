...
public class MappablePyramidRock0211 implements Mappable {

	private MappablePyramidRock0211() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0211();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
