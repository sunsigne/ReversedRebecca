...
public class MappablePyramidRock0209 implements Mappable {

	private MappablePyramidRock0209() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0209();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
