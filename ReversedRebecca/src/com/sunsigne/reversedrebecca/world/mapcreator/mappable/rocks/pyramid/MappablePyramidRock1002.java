...
public class MappablePyramidRock1002 implements Mappable {

	private MappablePyramidRock1002() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1002();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 2, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
