...
public class MappablePyramidRock1300 implements Mappable {

	private MappablePyramidRock1300() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1300();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
