...
public class MappablePyramidRock1101 implements Mappable {

	private MappablePyramidRock1101() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1101();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 1, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
