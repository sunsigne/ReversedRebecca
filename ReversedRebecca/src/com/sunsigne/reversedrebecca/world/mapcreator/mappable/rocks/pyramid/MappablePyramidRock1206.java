...
public class MappablePyramidRock1206 implements Mappable {

	private MappablePyramidRock1206() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1206();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 6, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
