...
public class MappablePyramidRock0104 implements Mappable {

	private MappablePyramidRock0104() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0104();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
