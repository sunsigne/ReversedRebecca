...
public class MappablePyramidRock1411 implements Mappable {

	private MappablePyramidRock1411() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1411();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
