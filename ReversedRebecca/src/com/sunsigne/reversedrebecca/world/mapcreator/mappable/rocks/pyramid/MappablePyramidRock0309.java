...
public class MappablePyramidRock0309 implements Mappable {

	private MappablePyramidRock0309() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0309();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
