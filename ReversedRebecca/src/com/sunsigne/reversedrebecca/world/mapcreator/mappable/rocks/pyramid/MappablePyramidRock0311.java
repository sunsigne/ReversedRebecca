...
public class MappablePyramidRock0311 implements Mappable {

	private MappablePyramidRock0311() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0311();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
