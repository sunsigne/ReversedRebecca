...
public class MappablePyramidRock0003 implements Mappable {

	private MappablePyramidRock0003() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0003();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);
		return rock;
	}
