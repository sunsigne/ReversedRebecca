...
public class MappablePyramidRock0111 implements Mappable {

	private MappablePyramidRock0111() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0111();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
