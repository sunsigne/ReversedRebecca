...
public class MappablePyramidRock1415 implements Mappable {

	private MappablePyramidRock1415() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1415();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 15, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
