...
public class MappablePyramidRock0807 implements Mappable {

	private MappablePyramidRock0807() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0807();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 7, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
