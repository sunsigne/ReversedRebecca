...
public class MappablePyramidRock1412 implements Mappable {

	private MappablePyramidRock1412() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1412();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 12, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
