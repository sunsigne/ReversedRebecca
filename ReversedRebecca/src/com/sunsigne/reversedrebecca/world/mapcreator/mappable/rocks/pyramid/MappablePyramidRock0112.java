...
public class MappablePyramidRock0112 implements Mappable {

	private MappablePyramidRock0112() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0112();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
