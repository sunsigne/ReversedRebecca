...
public class MappablePyramidRock0507 implements Mappable {

	private MappablePyramidRock0507() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0507();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 7, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
