...
public class MappablePyramidRock1414 implements Mappable {

	private MappablePyramidRock1414() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1414();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
