...
public class MappablePyramidRock0510 implements Mappable {

	private MappablePyramidRock0510() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0510();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 10, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
