...
public class MappablePyramidRock0007 implements Mappable {

	private MappablePyramidRock0007() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0007();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 7, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
