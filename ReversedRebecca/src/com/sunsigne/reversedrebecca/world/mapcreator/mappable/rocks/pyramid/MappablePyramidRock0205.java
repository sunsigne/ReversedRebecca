...
public class MappablePyramidRock0205 implements Mappable {

	private MappablePyramidRock0205() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0205();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 5, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
