...
public class MappablePyramidRock1111 implements Mappable {

	private MappablePyramidRock1111() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1111();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
