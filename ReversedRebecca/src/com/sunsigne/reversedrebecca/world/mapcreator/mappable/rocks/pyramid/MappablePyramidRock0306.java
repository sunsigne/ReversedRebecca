...
public class MappablePyramidRock0306 implements Mappable {

	private MappablePyramidRock0306() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0306();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
