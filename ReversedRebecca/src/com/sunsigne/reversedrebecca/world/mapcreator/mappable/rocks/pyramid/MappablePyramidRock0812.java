...
public class MappablePyramidRock0812 implements Mappable {

	private MappablePyramidRock0812() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0812();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
