...
public class MappablePyramidRock0901 implements Mappable {

	private MappablePyramidRock0901() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0901();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
