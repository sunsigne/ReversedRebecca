...
public class MappablePyramidRock0800 implements Mappable {

	private MappablePyramidRock0800() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0800();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
