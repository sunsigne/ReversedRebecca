...
public class MappablePyramidRock0301 implements Mappable {

	private MappablePyramidRock0301() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0301();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 1, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
