...
public class MappablePyramidRock0110 implements Mappable {

	private MappablePyramidRock0110() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0110();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 10, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
