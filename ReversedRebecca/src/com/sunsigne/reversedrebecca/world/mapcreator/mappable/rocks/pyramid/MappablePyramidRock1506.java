...
public class MappablePyramidRock1506 implements Mappable {

	private MappablePyramidRock1506() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1506();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 6, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
