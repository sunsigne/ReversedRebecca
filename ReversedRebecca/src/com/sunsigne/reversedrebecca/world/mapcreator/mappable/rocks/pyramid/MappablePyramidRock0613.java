...
public class MappablePyramidRock0613 implements Mappable {

	private MappablePyramidRock0613() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0613();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
