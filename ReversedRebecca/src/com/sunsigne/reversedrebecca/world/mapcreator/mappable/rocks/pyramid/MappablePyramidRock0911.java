...
public class MappablePyramidRock0911 implements Mappable {

	private MappablePyramidRock0911() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0911();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
