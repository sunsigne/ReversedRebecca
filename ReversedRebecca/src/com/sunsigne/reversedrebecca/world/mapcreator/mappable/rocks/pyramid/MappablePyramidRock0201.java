...
public class MappablePyramidRock0201 implements Mappable {

	private MappablePyramidRock0201() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0201();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 1, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
