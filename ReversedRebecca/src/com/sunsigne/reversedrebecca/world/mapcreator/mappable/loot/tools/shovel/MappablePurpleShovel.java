...
public class MappablePurpleShovel implements Mappable {

	private MappablePurpleShovel() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePurpleShovel();
	...
	public GameObject createObject(int x, int y) {
		return new ToolObject(new ShovelToolPlayer(), LVL.PURPLE, x, y);
	}
