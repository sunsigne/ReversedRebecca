...
public class MappablePyramidRock0215 implements Mappable {

	private MappablePyramidRock0215() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0215();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 15, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
