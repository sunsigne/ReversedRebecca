...
public class MappableCyanMicrochip implements Mappable {

	private MappableCyanMicrochip() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappableCyanMicrochip();
	...
	public GameObject createObject(int x, int y) {
		return new ToolObject(new MicrochipToolPlayer(), LVL.CYAN, x, y);
	}
