...
public class MappablePyramidRock1010 implements Mappable {

	private MappablePyramidRock1010() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1010();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
