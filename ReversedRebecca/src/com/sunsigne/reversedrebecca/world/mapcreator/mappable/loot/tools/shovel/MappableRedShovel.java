...
public class MappableRedShovel implements Mappable {

	private MappableRedShovel() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappableRedShovel();
	...
	public GameObject createObject(int x, int y) {
		return new ToolObject(new ShovelToolPlayer(), LVL.RED, x, y);
	}
