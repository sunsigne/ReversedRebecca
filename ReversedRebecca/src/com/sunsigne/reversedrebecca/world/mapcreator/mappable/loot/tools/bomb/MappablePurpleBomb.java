...
public class MappablePurpleBomb implements Mappable {

	private MappablePurpleBomb() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePurpleBomb();
	...
	public GameObject createObject(int x, int y) {
		return new ToolObject(new BombToolPlayer(), LVL.PURPLE, x, y);
	}
