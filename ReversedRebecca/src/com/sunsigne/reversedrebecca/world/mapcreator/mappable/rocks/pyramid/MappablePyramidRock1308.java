...
public class MappablePyramidRock1308 implements Mappable {

	private MappablePyramidRock1308() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1308();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
