...
public class MappablePyramidRock0200 implements Mappable {

	private MappablePyramidRock0200() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0200();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 0, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
