...
public class MappablePyramidRock1501 implements Mappable {

	private MappablePyramidRock1501() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1501();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
