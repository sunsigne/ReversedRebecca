...
public class MappablePyramidRock0801 implements Mappable {

	private MappablePyramidRock0801() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0801();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 1, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
