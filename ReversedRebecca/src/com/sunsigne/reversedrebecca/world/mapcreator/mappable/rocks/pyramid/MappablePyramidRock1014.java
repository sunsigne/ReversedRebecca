...
public class MappablePyramidRock1014 implements Mappable {

	private MappablePyramidRock1014() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1014();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 14, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
