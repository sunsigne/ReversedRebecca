...
public class MappablePyramidRock0015 implements Mappable {

	private MappablePyramidRock0015() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0015();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 15, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);
		return rock;
	}
