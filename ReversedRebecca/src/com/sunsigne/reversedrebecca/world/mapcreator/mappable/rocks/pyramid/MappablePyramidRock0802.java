...
public class MappablePyramidRock0802 implements Mappable {

	private MappablePyramidRock0802() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0802();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
