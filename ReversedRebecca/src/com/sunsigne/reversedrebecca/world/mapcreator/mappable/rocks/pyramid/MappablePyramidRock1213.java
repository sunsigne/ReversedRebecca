...
public class MappablePyramidRock1213 implements Mappable {

	private MappablePyramidRock1213() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1213();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
