...
public class MappablePyramidRock1214 implements Mappable {

	private MappablePyramidRock1214() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1214();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 14, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
