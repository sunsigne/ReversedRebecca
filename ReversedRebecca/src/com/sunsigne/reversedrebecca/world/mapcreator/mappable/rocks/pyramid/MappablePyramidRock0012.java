...
public class MappablePyramidRock0012 implements Mappable {

	private MappablePyramidRock0012() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0012();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
