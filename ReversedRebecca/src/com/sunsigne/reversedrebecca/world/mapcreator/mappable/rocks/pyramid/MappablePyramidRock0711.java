...
public class MappablePyramidRock0711 implements Mappable {

	private MappablePyramidRock0711() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0711();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 11, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
