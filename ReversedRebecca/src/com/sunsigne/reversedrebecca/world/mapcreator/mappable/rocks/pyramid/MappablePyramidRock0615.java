...
public class MappablePyramidRock0615 implements Mappable {

	private MappablePyramidRock0615() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0615();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
