...
public class MappablePyramidRock0011 implements Mappable {

	private MappablePyramidRock0011() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0011();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(0, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
