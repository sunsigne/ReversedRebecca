...
public class MappablePyramidRock1209 implements Mappable {

	private MappablePyramidRock1209() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1209();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 9, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
