...
public class MappablePyramidRock0314 implements Mappable {

	private MappablePyramidRock0314() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0314();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
