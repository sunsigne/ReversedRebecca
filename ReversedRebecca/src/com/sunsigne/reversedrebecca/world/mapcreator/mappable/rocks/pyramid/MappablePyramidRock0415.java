...
public class MappablePyramidRock0415 implements Mappable {

	private MappablePyramidRock0415() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0415();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
