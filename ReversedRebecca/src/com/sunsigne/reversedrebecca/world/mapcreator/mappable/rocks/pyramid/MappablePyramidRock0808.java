...
public class MappablePyramidRock0808 implements Mappable {

	private MappablePyramidRock0808() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0808();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
