...
public class MappablePyramidRock1008 implements Mappable {

	private MappablePyramidRock1008() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1008();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 8, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
