...
public class MappablePyramidRock0804 implements Mappable {

	private MappablePyramidRock0804() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0804();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(8, 4, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
