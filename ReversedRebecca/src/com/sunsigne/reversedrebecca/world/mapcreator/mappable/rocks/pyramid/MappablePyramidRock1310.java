...
public class MappablePyramidRock1310 implements Mappable {

	private MappablePyramidRock1310() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1310();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
