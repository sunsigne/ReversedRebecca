...
public class MappablePyramidRock0213 implements Mappable {

	private MappablePyramidRock0213() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0213();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
