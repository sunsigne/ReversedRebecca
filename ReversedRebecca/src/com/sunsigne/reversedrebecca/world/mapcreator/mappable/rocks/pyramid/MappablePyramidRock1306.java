...
public class MappablePyramidRock1306 implements Mappable {

	private MappablePyramidRock1306() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1306();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
