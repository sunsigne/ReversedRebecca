...
public class MappablePyramidRock0706 implements Mappable {

	private MappablePyramidRock0706() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0706();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
