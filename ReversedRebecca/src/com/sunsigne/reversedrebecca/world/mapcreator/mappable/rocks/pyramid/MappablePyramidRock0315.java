...
public class MappablePyramidRock0315 implements Mappable {

	private MappablePyramidRock0315() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0315();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
