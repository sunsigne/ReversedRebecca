...
public class MappablePyramidRock0113 implements Mappable {

	private MappablePyramidRock0113() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0113();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 13, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
