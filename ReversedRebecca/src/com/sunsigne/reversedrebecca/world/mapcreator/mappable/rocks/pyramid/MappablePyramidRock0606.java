...
public class MappablePyramidRock0606 implements Mappable {

	private MappablePyramidRock0606() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0606();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
