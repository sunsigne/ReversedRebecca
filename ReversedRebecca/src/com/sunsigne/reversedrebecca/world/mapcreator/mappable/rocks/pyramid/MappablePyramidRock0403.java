...
public class MappablePyramidRock0403 implements Mappable {

	private MappablePyramidRock0403() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0403();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 3, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
