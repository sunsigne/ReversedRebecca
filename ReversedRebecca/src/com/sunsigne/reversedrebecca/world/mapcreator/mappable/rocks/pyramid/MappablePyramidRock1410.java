...
public class MappablePyramidRock1410 implements Mappable {

	private MappablePyramidRock1410() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1410();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
