...
public class MappablePyramidRock0101 implements Mappable {

	private MappablePyramidRock0101() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0101();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 1, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
