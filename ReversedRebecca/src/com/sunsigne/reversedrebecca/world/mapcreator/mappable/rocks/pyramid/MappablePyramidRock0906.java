...
public class MappablePyramidRock0906 implements Mappable {

	private MappablePyramidRock0906() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0906();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 6, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
