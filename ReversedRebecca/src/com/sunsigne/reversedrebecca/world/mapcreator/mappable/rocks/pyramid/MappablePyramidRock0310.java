...
public class MappablePyramidRock0310 implements Mappable {

	private MappablePyramidRock0310() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0310();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 10, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
