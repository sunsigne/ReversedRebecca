...
public class MappablePyramidRock0608 implements Mappable {

	private MappablePyramidRock0608() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0608();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 8, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
