...
public class MappableOrangeMicrochip implements Mappable {

	private MappableOrangeMicrochip() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappableOrangeMicrochip();
	...
	public GameObject createObject(int x, int y) {
		return new ToolObject(new MicrochipToolPlayer(), LVL.ORANGE, x, y);
	}
