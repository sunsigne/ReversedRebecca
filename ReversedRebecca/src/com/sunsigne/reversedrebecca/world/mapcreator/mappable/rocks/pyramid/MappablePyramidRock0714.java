...
public class MappablePyramidRock0714 implements Mappable {

	private MappablePyramidRock0714() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0714();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 14, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
