...
public class MappablePyramidRock1313 implements Mappable {

	private MappablePyramidRock1313() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1313();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
