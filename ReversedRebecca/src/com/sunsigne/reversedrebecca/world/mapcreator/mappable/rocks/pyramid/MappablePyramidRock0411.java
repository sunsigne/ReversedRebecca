...
public class MappablePyramidRock0411 implements Mappable {

	private MappablePyramidRock0411() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0411();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
