...
public class MappablePyramidRock1509 implements Mappable {

	private MappablePyramidRock1509() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1509();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
