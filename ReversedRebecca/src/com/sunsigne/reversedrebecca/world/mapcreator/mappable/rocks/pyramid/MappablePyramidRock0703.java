...
public class MappablePyramidRock0703 implements Mappable {

	private MappablePyramidRock0703() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0703();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(7, 3, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
