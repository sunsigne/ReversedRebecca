...
public class MappablePyramidRock0312 implements Mappable {

	private MappablePyramidRock0312() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0312();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 12, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
