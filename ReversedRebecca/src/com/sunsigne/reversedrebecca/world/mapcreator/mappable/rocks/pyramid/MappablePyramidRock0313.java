...
public class MappablePyramidRock0313 implements Mappable {

	private MappablePyramidRock0313() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0313();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(3, 13, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
