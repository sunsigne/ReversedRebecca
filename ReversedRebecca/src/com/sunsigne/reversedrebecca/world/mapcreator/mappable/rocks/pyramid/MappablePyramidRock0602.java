...
public class MappablePyramidRock0602 implements Mappable {

	private MappablePyramidRock0602() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0602();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
