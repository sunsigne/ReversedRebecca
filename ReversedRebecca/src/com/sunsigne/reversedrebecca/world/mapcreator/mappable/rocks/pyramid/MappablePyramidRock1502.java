...
public class MappablePyramidRock1502 implements Mappable {

	private MappablePyramidRock1502() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1502();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(15, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
