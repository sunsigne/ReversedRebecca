...
public class MappablePyramidRock0413 implements Mappable {

	private MappablePyramidRock0413() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0413();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 13, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);
		return rock;
	}
