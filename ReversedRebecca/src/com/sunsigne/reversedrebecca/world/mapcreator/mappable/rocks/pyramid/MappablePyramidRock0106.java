...
public class MappablePyramidRock0106 implements Mappable {

	private MappablePyramidRock0106() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0106();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 6, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
