...
public class MappablePyramidRock0912 implements Mappable {

	private MappablePyramidRock0912() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0912();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
