...
public class MappablePyramidRock1006 implements Mappable {

	private MappablePyramidRock1006() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1006();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 6, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
