...
public class MappablePyramidRock0515 implements Mappable {

	private MappablePyramidRock0515() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0515();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(5, 15, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
