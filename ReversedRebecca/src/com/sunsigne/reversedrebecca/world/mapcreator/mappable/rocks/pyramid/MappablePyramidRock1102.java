...
public class MappablePyramidRock1102 implements Mappable {

	private MappablePyramidRock1102() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1102();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
