...
public class MappablePyramidRock1108 implements Mappable {

	private MappablePyramidRock1108() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1108();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 8, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
