...
public class MappablePyramidRock1007 implements Mappable {

	private MappablePyramidRock1007() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1007();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 7, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
