...
public class MappablePyramidRock0109 implements Mappable {

	private MappablePyramidRock0109() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0109();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 9, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
