...
public class MappablePyramidRock1000 implements Mappable {

	private MappablePyramidRock1000() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1000();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(10, 0, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
