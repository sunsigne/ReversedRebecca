...
public class MappablePyramidRock0902 implements Mappable {

	private MappablePyramidRock0902() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0902();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(9, 2, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
