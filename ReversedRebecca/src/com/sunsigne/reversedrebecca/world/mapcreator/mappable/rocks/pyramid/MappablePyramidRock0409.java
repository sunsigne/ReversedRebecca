...
public class MappablePyramidRock0409 implements Mappable {

	private MappablePyramidRock0409() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0409();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(4, 9, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
