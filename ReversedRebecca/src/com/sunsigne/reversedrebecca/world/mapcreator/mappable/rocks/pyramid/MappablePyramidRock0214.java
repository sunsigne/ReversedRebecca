...
public class MappablePyramidRock0214 implements Mappable {

	private MappablePyramidRock0214() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0214();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(2, 14, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
