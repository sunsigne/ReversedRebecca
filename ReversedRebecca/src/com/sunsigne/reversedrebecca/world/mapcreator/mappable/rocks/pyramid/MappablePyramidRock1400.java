...
public class MappablePyramidRock1400 implements Mappable {

	private MappablePyramidRock1400() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1400();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(14, 0, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
