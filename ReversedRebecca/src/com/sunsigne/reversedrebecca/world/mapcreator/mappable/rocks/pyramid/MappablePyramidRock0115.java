...
public class MappablePyramidRock0115 implements Mappable {

	private MappablePyramidRock0115() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0115();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(1, 15, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
