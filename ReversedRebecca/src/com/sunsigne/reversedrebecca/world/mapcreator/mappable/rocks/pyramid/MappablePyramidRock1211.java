...
public class MappablePyramidRock1211 implements Mappable {

	private MappablePyramidRock1211() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1211();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(12, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
