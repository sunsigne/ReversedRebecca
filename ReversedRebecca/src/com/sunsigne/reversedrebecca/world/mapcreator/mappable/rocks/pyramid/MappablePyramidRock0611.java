...
public class MappablePyramidRock0611 implements Mappable {

	private MappablePyramidRock0611() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock0611();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(6, 11, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
