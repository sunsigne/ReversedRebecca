...
public class MappablePyramidRock1302 implements Mappable {

	private MappablePyramidRock1302() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1302();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(13, 2, RockSize.PYRAMID[0], RockSize.PYRAMID[1]);		
		return rock;
	}
