...
public class MappablePyramidRock1112 implements Mappable {

	private MappablePyramidRock1112() {
		new MapCreator().getList().addObject(this);
	}

	private static Mappable mappable = new MappablePyramidRock1112();
	...
	public GameObject createObject(int x, int y) {
		...
		rock.setBounds(11, 12, RockSize.PYRAMID[2], RockSize.PYRAMID[3]);		
		return rock;
	}
