...
public class DigSwordToolObject extends DigToolObject {

	public DigSwordToolObject(Puzzle puzzle, int x_pos_in_menu, int y_pos_in_menu, int w, int h, boolean selectable) {
