package com.sunsigne.reversedrebecca.menu.submenu.options;
...
import com.sunsigne.reversedrebecca.object.menu.buttons.ActionOptionPreview;
...
import com.sunsigne.reversedrebecca.object.menu.buttons.TitleScreenTextSelectable;
...
public class GeneralScreen extends SubMenuScreen implements SheetableImage {
	...
	public static final PresetMousePos ACTION_HIGHLIGHT = new PresetMousePos(925 - 269 + gap, 460);
	public static final PresetMousePos ACTION_DESIGN = new PresetMousePos(925 - 269 + gap, 570);
