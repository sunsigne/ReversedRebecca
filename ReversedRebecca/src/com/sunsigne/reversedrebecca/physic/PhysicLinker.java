...
import com.sunsigne.reversedrebecca.physic.natural.independant.LoadingScreenEverywhereLaw;
...
public class PhysicLinker {
	...
	private static final IndependantLaw I_LOADING = new LoadingScreenEverywhereLaw().getIndependantLaw();
	...
	public static final PhysicLaw[] PLAYER = { C_VELOCITY, C_GOAL, C_COLLISION, C_TILE, C_PATH, C_CAMERA, C_SHAKE,
			I_BLINKING, I_DRUNK, I_FADE_PUZZLE, I_HIGHLIGHT, I_DEATH, I_LOADING, I_MOUSE, I_PLAYER, I_WAITFOR, D_SWIFT, D_HITBOX,
			D_WALLPASS };
	...
	public static final PhysicLaw[] SHAKER = { C_SHAKE, I_DRUNK, I_LOADING };
